        ...
        <div className='container mx-w-4xl mx-auto text-center z-10'>
            <div className='space-y-6'>
                ...
                <p className="text-lg md:text-xl text-muted-foreground mx-auto opacity-0 animate-fade-in-delay-3">
                    I build exceptional web experiences end-to-end — from seamless, responsive interfaces to robust, scalable backends. My work bridges design and technology to deliver fast, intelligent, and meaningful digital products.
                </p>
